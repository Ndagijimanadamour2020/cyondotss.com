...
<div class="row">
  ...
  <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">
          <?php 
            $course = $conn->query("SELECT * FROM course_list where `status` = 1 ")->num_rows;
  ...
  <div class="col-12 col-sm-6 col-md-6 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Unpublished Announcement</span>
        <span class="info-box-number">
          <?php 
  ...
  <div class="col-12 col-sm-6 col-md-6 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Published Announcement</span>
        <span class="info-box-number">
          <?php 
...
<div class="container">
  <?php 
    $files = array();
      $fopen = scandir(base_app.'uploads/banner1');
      foreach($fopen as $fname){
        if(in_array($fname,array('.','..')))
          continue;
        $files[]= validate_image('uploads/banner1/'.$fname);
      }
  ?>
