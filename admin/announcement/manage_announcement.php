...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h5 class="card-title"><b><?= isset($id) ? "Update Article" : "New Announcement" ?></b></h5>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="custom-control custom-checkbox">
                          ...
                          <label for="status" class="custom-control-label">Publish Announcement</label>
                        </div>
                    </div>
                </div>
            </form>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						...
						location.replace("./?page=announcement/view_announcement&id="+resp.aid)
