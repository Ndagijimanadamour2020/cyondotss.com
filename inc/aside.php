...
<div class="card shadow rounded-0 shadow mb-4">
    <div class="card-header">
        <div class="card-title font-weight-bolder" style="color:red;">Recent announcement(s)</div>
    </div>
    <div class="card-body">
        <div class="list-group">
            ...
            ?>
            <a href="./?p=blogs/view_blog&id=<?= $row['id'] ?>" class="list-group-item list-group-item-action text-decoration-none" style="color:blue;"><marquee class="blink" behavior="scroll"direction="left" scrollamount="3"><p class="text-truncate m-0"><?= $row['title'] ?></p></marquee></a>
...
<div class="card shadow rounded-0 shadow mb-4">
    <div class="card-header">
        <div class="card-title font-weight-bolder" style="color:red;">Departments</div>
    </div>
    <div class="card-body">
        <div class="list-group">
            <?php 
...
<div class="card shadow rounded-0 shadow mb-4">
    <div class="card-header">
        <div class="card-title font-weight-bolder" style="color:red;">Courses</div>
    </div>
    <div class="card-body">
        <div class="list-group">
            <?php 
